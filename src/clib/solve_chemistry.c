                    ...
                    solver_fields *output_fields)
{
  ...
  if(grackle_data->primordial_chemistry>0){
    for(int i=0;i<1;i++){
      ...
      fprintf(stdout, "HeII : %e \n",my_fields->HeII_density[1]*my_units->density_units);
      fprintf(stdout, "HeIII : %e \n",my_fields->HeIII_density[1]*my_units->density_units);
      fprintf(stdout, "e- : %e \n",my_fields->e_density[1]*my_units->density_units);
      if(grackle_data->primordial_chemistry>1){
      fprintf(stdout, "HM : %e \n",my_fields->HM_density[1]*my_units->density_units);
      fprintf(stdout, "H2I : %e \n",my_fields->H2I_density[1]*my_units->density_units);
      fprintf(stdout, "H2II : %e \n",my_fields->H2II_density[1]*my_units->density_units);
      }
      if(grackle_data->primordial_chemistry>2){
      fprintf(stdout, "DI : %e \n",my_fields->DI_density[1]*my_units->density_units);
      fprintf(stdout, "DII : %e \n",my_fields->DII_density[1]*my_units->density_units);
      fprintf(stdout, "HDI : %e \n",my_fields->HDI_density[1]*my_units->density_units);
      }      
      if(my_fields->metal_density!=NULL){
      fprintf(stdout, "metal : %e \n",my_fields->metal_density[1]*my_units->density_units);
      }
      if(my_fields->dust_density!=NULL){
      fprintf(stdout, "dust : %e \n",my_fields->dust_density[1]*my_units->density_units);
      }      
    }
  ...
  *********************************************************************/
  ...
  //temperature = malloc(Ncells * sizeof(gr_float));
  ...
  //pressure = malloc(Ncells * sizeof(gr_float));
  if (calculate_pressure(my_units, my_fields,
                         output_fields->pressure) == 0) {
  ...
  // Calculate gamma.
  //gr_float *gamma;
  //gamma = malloc(Ncells * sizeof(gr_float));
