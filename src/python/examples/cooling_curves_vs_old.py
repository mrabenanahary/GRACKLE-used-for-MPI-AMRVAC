...
filenames = ["marches-tu.csv",
            "marches-tu_atomes.csv",
...
for i,el in enumerate(filenames):    
    ...
    pyplot.semilogy(np.log10(Xdata), Ydata,
                  color=a4[i],lw=a9[i], marker=a13[i],ls=a10[i],label=r'{:s}'.format(a5[i]))
    pyplot.xlabel(r'T [K]')
...
pyplot.tight_layout()
pyplot.savefig("cooling_curve_vs_original.pdf")
