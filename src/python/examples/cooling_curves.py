...
a4=['cyan','brown','purple','cyan','brown','purple']
a5=['Th. equil. atom. chem. A',
'Th. non-equil. atom. chem. A',
'Th. non-equil. H2 chem. (no deuter.) A',
'Th. equil. atom. chem. B',
'Th. non-equil. atom. chem. B',
'Th. non-equil. H2 chem. (no deuter.) B']
a6=[True,True,True,True,True,True]
a7=[0,1,2,0,1,2]
a3=[False,False,False,True]
a8=["CloudyData_noUVB.h5","CloudyData_noUVB.h5","CloudyData_noUVB.h5",
"CloudyData_UVB=HM2012_high_density.h5","CloudyData_UVB=HM2012_high_density.h5","CloudyData_UVB=HM2012_high_density.h5"]
a9=[1.0,1.0,1.0,4.0,4.0,4.0]
a10=['-','-','-','--','--','--']
a13=['None','None','None','None','None','None']

dchemistry=[0,0,1,0,0,1]
h2dust = [0,0,1,0,0,1]
...
for i,el in enumerate(a4):    
    ...
    my_chemistry.primordial_chemistry = a7[i]
    my_chemistry.dust_chemistry = dchemistry[i]
    my_chemistry.h2_on_dust = h2dust[i]
    ...
    pyplot.semilogy(np.log10(data["temperature"]), data["cooling_rate"],
                  color=a4[i],lw=a9[i], marker=a13[i],markersize=0,ls=a10[i],label=r'{:s}'.format(a5[i]))
...
pyplot.tight_layout()
pyplot.savefig("cooling_curve.pdf")
